...
class Data_driver():
    ...
    DATA_PARAMS = {
        "path": "./data/7x10_actions/XSens/xml", #,"./data/mvnx"
        "nb_frames": 70,
    ...
    def parse_MVNX(self, frameMod=True):
        ...
        print("data shape -1 supposed to be 66..."+str(self.data.shape[-1]))
        self.input_dim = self.data.shape[-1]
